...
public class TaskAdapter extends ArrayAdapter<Task> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(task_priority.equals("High")) status.setBackgroundColor(convertView.getResources().getColor(R.color.colorHigh));
        else if(task_priority.equals("Medium")) status.setBackgroundColor(convertView.getResources().getColor(R.color.colorMedium));
        else if(task_priority.equals("Low")) status.setBackgroundColor(convertView.getResources().getColor(R.color.colorLow));
        return convertView;
    }
}